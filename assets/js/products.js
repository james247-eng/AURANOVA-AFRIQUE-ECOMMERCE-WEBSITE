...
const productsData = [
    {
        ...
        price: 85000,
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSXbCVScbJ6S0uWnAsKYzyVh9koxu0nB0C13Q&s',
        badges: ['new', 'limited'],
        description: 'Luxurious hand-embroidered kaftan with traditional African motifs. Crafted from premium fabrics with meticulous attention to detail, this piece represents the perfect fusion of traditional African elegance and contemporary fashion.',
        sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    ...
    },
    {
        ...
        price: 120000,
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTA09VuwT4dZ3dm0ILYa_0oB4oW8tgG7j9ipQ&s',
        badges: ['new'],
    ...
    },
    {
        ...
        price: 45000,
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQWPAPU7UjvnG1Wpvhj63GTeS6REeCLJvDhqQ&s',
        badges: [],
        description: 'Traditional agbada and Yoruba cap crafted from premium Aso Oke fabric',
        sizes: ['One Size'],
    ...
    },
    {
        ...
        category: 'Face Caps',
        price: 25000,
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3MHoTYQbgwsFvhYllB2P7aLOSeDjG6VB1ZQ&s',
        badges: [],
    ...
    },
    {
        ...
        category: 'Premium Caftans',
        price: 150000,
        image: 'https://davidscottonline.com/cdn/shop/files/292417389_116757544405828_8778917058962022744_n.jpg?v=1704578489',
        badges: ['limited'],
    ...
    },
    {
        ...
        category: 'English Wears',
        price: 95000,
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSIUVDo1y9fGp9Pr7xCdRMfQ1wTFDdokPWZDQ&s',
        badges: ['new'],
    ...
    },
    {
        ...
        price: 38000,
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTG0_mN3B49bIerVUWTjToP61CxxkjbpWT61w&s',
        badges: [],
    ...
    },
    {
        ...
        category: 'Face Caps',
        price: 18000,
        image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRnztQjsZITCpzs9p0TQDpqjyGTkCXHcA_NSg&s',
        badges: ['new'],
...
function createProductCard(product) {
    ...
    const badgeHTML = product.badges.map(badge => {
        const badgeClass = badge === 'new' ? 'badge new' : badge === 'limited' ? 'badge limited' : 'badge';
        const badgeText = badge === 'new' ? 'NEW' : badge === 'limited' ? 'LIMITED' : badge.toUpperCase();
