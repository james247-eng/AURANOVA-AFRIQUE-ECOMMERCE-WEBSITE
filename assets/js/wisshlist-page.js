...
function loadWishlist() {
  ...
  console.log("Loaded wishlist items:", wishlist.length, wishlist);
...
function displayWishlistItems() {
  ...
  console.log("Displaying", wishlist.length, "wishlist items");
  container.innerHTML = "";
  ...
  shareButtons.forEach((btn, index) => {
    btn.addEventListener("click", function () {
      ...
      switch (index) {
        ...
        case 1: // Twitter
          window.open(
            `https://twitter.com/intent/tweet?url=${url}&text=Check out my AURANOVA-AFRIQUE wishlist!`,
            "_blank",
          );
          break;
        case 2: // WhatsApp
          window.open(
            `https://wa.me/?text=Check out my AURANOVA-AFRIQUE wishlist! ${url}`,
            "_blank",
          );
          break;
        case 3: // Copy Link
...
// Get products from productsData in products.js
const products =
  typeof productsData !== "undefined"
    ? productsData
    : window.auranovaProducts?.productsData || [];
console.log("Loading recommended products. Available:", products.length);
