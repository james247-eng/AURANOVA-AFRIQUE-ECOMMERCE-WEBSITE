...
/* ==========================================
   PROFILE ICON ROUTING (User vs Admin)
   ========================================== */
function initProfileRouting() {
  const profileLinks = document.querySelectorAll(
    'a[href="pages/my-account.html"], a[href="../pages/my-account.html"]',
  );
  ...
  profileLinks.forEach((link) => {
    link.addEventListener("click", function (e) {
      ...
      console.log("Profile click - User:", !!userStr, "Admin:", !!adminStr);

      if (adminStr) {
        // Redirect to admin dashboard
        e.preventDefault();
        window.location.href = adminStr.includes("../")
          ? "index.html"
          : "../admin/index.html";
      } else if (userStr) {
        // Go to user account (default behavior)
        return true;
      } else {
...
function showNotification(message, type = "info") {
  ...
  closeBtn.style.cssText =
    "background: none; border: none; color: inherit; font-size: 1.5rem; cursor: pointer; padding: 0; margin-left: auto;";
